...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "flex h-11 w-full items-center justify-between gap-2 rounded-lg border px-4 py-2 text-sm shadow-xs",
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "relative z-[var(--z-popover)] max-h-96 min-w-[8rem] overflow-hidden rounded-lg border border-border shadow-lg",
